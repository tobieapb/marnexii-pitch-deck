...
export function ProductSlide({ isActive }: ProductSlideProps) {
  ...
  return (
    <div className="relative h-full w-full flex items-center justify-center overflow-hidden">
      ...
      >
        <h2 className="text-3xl sm:text-4xl md:text-7xl font-light mb-6 md:mb-12 text-balance leading-tight text-center">
          The System That <span className="text-primary">Sees Everything</span>
        </h2>

        <div className="text-center mb-8 md:mb-16 space-y-3 md:space-y-4 text-base sm:text-lg md:text-xl text-muted-foreground px-4">
          ...
          <p className="text-balance text-sm sm:text-base md:text-lg mt-4 md:mt-6">
        ...
        <div className="grid md:grid-cols-3 gap-4 md:gap-6">
          <div
            className={`p-4 md:p-6 border border-border bg-card/50 backdrop-blur-sm transition-all duration-700 hover:border-primary ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
            style={{ transitionDelay: "200ms" }}
          >
            <div className="aspect-video bg-secondary/30 rounded mb-3 md:mb-4 flex items-center justify-center">
              <img
            ...
            <h3 className="text-lg md:text-xl font-light mb-1 md:mb-2">Station Dashboard</h3>
            <p className="text-xs md:text-sm text-muted-foreground">Real-time monitoring and analytics</p>
          </div>

          <div
            className={`p-4 md:p-6 border border-border bg-card/50 backdrop-blur-sm transition-all duration-700 hover:border-accent ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
          ...
          >
            ...
            <h3 className="text-lg md:text-xl font-light mb-1 md:mb-2">Vessel Map Viewer</h3>
          ...
          >
            ...
            <h3 className="text-lg md:text-xl font-light mb-1 md:mb-2">Metrics System</h3>
